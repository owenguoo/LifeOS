...
class OpenAIService:
        ...
        try:
            ...
            response = self.client.chat.completions.create(
                ...
                messages=[
                    ...
                    {
                        "role": "user",
                        "content": f"Refine this input into a search query: {user_input}",
                    },
                ],
                max_tokens=100,
                temperature=0.3,
    ...
    def generate_contextual_response(
        self, user_question: str, video_contexts: list
    ) -> Optional[str]:
        """
        ...
        try:
            ...
            if generated_response:
                ...
                logger.info(
                    f"Generated contextual response for question: '{user_question}'"
                )
