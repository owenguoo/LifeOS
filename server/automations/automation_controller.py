...
class AutomationController:
    ...
    async def process_video_summary(self, video_id: str, summary: str, metadata: Dict[str, Any]) -> Dict[str, Any]:
        """
        ...
        try:
            ...
            if "calendar" in triggered_automations:
                automation_tasks.append(
                    self._run_calendar_automation(video_id, summary, analysis_result, metadata)
                )
    ...
    async def get_automation_history(self, user_id: str, limit: int = 50) -> List[Dict[str, Any]]:
