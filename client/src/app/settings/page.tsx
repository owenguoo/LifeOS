        ...
        <div className="container mx-auto max-w-4xl">
          ...
          >
            {automations.map((automation) => (
              <motion.div
                key={automation.id}
                className="glass-effect rounded-lg p-4 border border-border hover:border-primary/30"
                ...
                <div className="flex items-center justify-between gap-2">
                  ...
                  <div className="flex-shrink-0 w-10 h-10 flex items-center justify-center">
                    ...
                    {automation.id === 'google-calendar' && (
                      <Image src="/google_calendar.svg" alt="Google Calendar" width={24} height={24} className="w-6 h-6" />
                    )}
                  </div>
          ...
          >
            <motion.button
               ...
               className="w-full glass-effect rounded-lg p-4 border border-border hover:border-primary/30 flex items-center justify-center gap-3 group"
               whileHover={{ scale: 1.02, y: -2 }}
               whileTap={{ scale: 0.98 }}
               transition={{ duration: 0.1 }}
             >
               <svg className="w-6 h-6 text-text-accent group-hover:rotate-90 transition-transform duration-150" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6v6m0 0v6m0-6h6m-6 0H6" />
              </svg>
              <span className="text-lg font-semibold text-text-primary">Add an automation</span>
            </motion.button>
          </motion.div>
        </div>
      </main>
